 ...
 */
class RandomPolicyTest extends TestDriver {
    ...
    public static void main(String argv[]) {
        ...
        RandomPolicyTest bmt = new RandomPolicyTest();
    ...
    protected boolean randomTest() {
        ...
        for (pid.pid = firstPid.pid, lastPid.pid = pid.pid + (numPages*3/4); status == PASS && pid.pid < lastPid.pid; pid.pid = pid.pid + 1) {
        ...
        for (pid.pid = firstPid.pid, lastPid.pid = pid.pid+numPages*3; pid.pid < lastPid.pid; pid.pid = pid.pid + 1) {
            ...
            if (status == PASS) {    
                try {
                    ...
                    status = FAIL;
                    System.err.print("*** Could not unpin dirty page " + rPid.pid + "\n");
                    e.printStackTrace();
                }
